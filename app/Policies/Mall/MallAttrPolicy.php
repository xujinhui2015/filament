...
class MallAttrPolicy
{
    ...
    {
        return $user->can('view_any_mall::mall::attr');
    }
    ...
    {
        return $user->can('create_mall::mall::attr');
    }
    ...
    {
        return $user->can('update_mall::mall::attr');
    }
    ...
    {
        return $user->can('delete_mall::mall::attr');
    }
    ...
    {
        return $user->can('delete_any_mall::mall::attr');
    }
    ...
    {
        return $user->can('force_delete_mall::mall::attr');
    }
    ...
    {
        return $user->can('force_delete_any_mall::mall::attr');
    }
    ...
    {
        return $user->can('restore_mall::mall::attr');
    }
    ...
    {
        return $user->can('restore_any_mall::mall::attr');
    }
    ...
    {
        return $user->can('reorder_mall::mall::attr');
    }
}
